...
const Information = (props) => {
  ...
  return (
    <div className="justify-center items-center" id="info">
      <div className="bg-neutral-100 flex flex-col shadow-md max-w-sexy rounded-xl p-5" id="infofield">
        <div className="flex flex-col py-5 px-24 bg-supporange-200 rounded-md justify-center items-center">
